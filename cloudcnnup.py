...
class CloudSrvr:
    ...
    def trainall(self):
        ...
        cnn_predictions = (self.machinemodels["cnn"].predict(Xtestcnn) > 0.5).astype("int32")
        combined_predictions = (enspre + cnn_predictions.flatten()) / 2
        combined_predictions = (combined_predictions > 0.5).astype("int32")
        combined_acc = accuracy_score(ytest, combined_predictions)
        print("Combined CNN and Ensemble Accuracy is:", combined_acc)
